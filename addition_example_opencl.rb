...
source = <<EOF
__kernel void addition(  int length, __global const int *in, __global int *out) { \
...
event = prog.addition(queue, [size], length, b_in, b_out, :local_work_size => [128])
